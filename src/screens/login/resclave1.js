...
class Restablece1Screen extends Component {
    render() {
            ...
            <View style={styles.container}>
                ...
                <View style={styles.container2}>
                    ...
                    <View style={styles.footer}>
                        ...
                        <Text style={styles.recordatorio}>Ingresa el código enviado</Text>
                        <TextInput
                        ...
                        <TouchableOpacity
                            ...
                            >
                                <Text style={{color: '#575855'}}>RESTABLECER</Text>
                        </TouchableOpacity>
...
export default Restablece1Screen;
